classdef ThorDo < RobotBaseClass
    %% DobotMagician
...
%% RealQToModelQ
        ...
        function modelQ = RealQToModelQ(realQ)
            modelQ = realQ;
            modelQ(3) = ThorDo.ComputeModelQ3GivenRealQ2and3( realQ(2), realQ(3) );
...
%% ModelQToRealQ
        ...
        function realQ = ModelQToRealQ( modelQ )
            realQ = modelQ;
            realQ(3) = ThorDo.ComputeRealQ3GivenModelQ2and3( modelQ(2), modelQ(3) );
        end
